...
1.  What is the difference in expenditures between recreational workers in 1930s-1960s New England and Southern states and why did this difference exist based on prominence of recreational potential?
...
```{r}
recreational.data <- read_csv("https://raw.githubusercontent.com/regan008/DigitalMethodsData/main/raw/Recreation-Expenditures.csv")
```
