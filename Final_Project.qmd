...
Population was very much affected in different states by however much the government funded recreational programs for each one. It also depended on the geography of a state which could allow for recreation to thrive. For example, in states like

## Conclusion

It is intriguing to see from my analysis the way which populations fluctuated in different states, based on the recreational expenditure, and tied to however prominent recreational activity was in each state. Recognizing the difference in populations of Southern vs Northern states makes sense when considering the divide between rural and urban geography. The rural states like South Carolina and South Dakota have a lower population density because they received less government funding
