...
My analysis on the difference in expenditures for Northern and Southern states during the 1930s as well as their impact on recreational workers demonstrates as time went on, the number of workers gradually increased, and the economy improved into the 1940s. Additionally, the data suggests that Southern states, with the exception of Texas, paid lower expenditures than the North. This had to deal with differences in geography particularly regarding urban vs. rural landscapes and

The reason why Texas stood out in terms of expenditure was because during the Great Depression, according to the Texas State Historical Association, the state was the epicenter of the Civilian Conservation Corps programs.[^7] In the article "Great Depression" by Ben Procter and Brian Cervantez, "The CCC, a nationwide program, for young men that focused on natural resources from 1933 to 1942, was very active in Texas. At its peak in 1935 the corps had twenty seven camps in Texas constructing recreational parks and an additional seventy camps for work in forest and soil conservation."[^8] Therefore, based on this secondary source and the data demonstrated by my analysis, Texas was the state with the most potential for recreation in the South.
