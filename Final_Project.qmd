...
Given these results, expenditure relates very much to state population during the 1930s because of various political and economic circumstances brought on by the Great Depression. Some of these included racial and sexual discrimination, geographical differences between regions of the United States, and they all had an effect on both the South and North in different ways. Since racial discrimination was more prominent in the South,
